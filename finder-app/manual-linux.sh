...
# TODO: Create necessary base directories
    ...
    cd ${OUTDIR}/rootfs
    mkdir -p bin sbin etc proc sys usr/bin usr/sbin home dev tmp lib lib64
cd "$OUTDIR"
if [ ! -d "${OUTDIR}/busybox" ]
then
...
echo "Copying related scripts to home directory"
...
echo "Adding permission to root directory"
    cd ${OUTDIR}/rootfs
...
echo "Kernel build successfull incluiding root tree" 
